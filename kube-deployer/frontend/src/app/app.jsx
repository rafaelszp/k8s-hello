                ...
                <div className="row">
                    ...
                    <div className="col-lg-3 col-xs-6">
                        ...
                        <div className="small-box bg-green">
                            <div className="inner">
                                <h3>53<sup alt="font-size: 20px">%</sup></h3>
                    ...
                    <section className="col-lg-7 connectedSortable">
                        ...
                        <div className="nav-tabs-custom">
                            ...
                            <div className="tab-content no-padding">
                                ...
                                <div className="chart tab-pane active" id="revenue-chart" alt="position: relative; height: 300px;"></div>
                                <div className="chart tab-pane" id="sales-chart" alt="position: relative; height: 300px;"></div>
                            </div>
                        </div>
                        ...
                        <div className="box box-info">
                            ...
                            <div className="box-body">
                                <form action="#" method="post">
                                    ...
                                    <div>
                                        <textarea className="textarea" placeholder="Message" alt="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                    </div>
                                </form>
                            </div>
                    ...
                    <section className="col-lg-5 connectedSortable">
                        ...
                        <div className="box box-solid bg-light-blue-gradient">
                            <div className="box-header">
                                ...
                                <div className="pull-right box-tools">
                                    ...
                                    <button type="button" className="btn btn-primary btn-sm pull-right" data-widget="collapse" data-toggle="tooltip" title="Collapse" alt="margin-right: 5px;">
                            ...
                            <div className="box-body">
                                <div id="world-map" alt="height: 250px; width: 100%;"></div>
                            </div>
                            
                            <div className="box-footer no-border">
                                <div className="row">
                                    <div className="col-xs-4 text-center" alt="border-right: 1px solid #f4f4f4">
                        ...
                        <div className="box box-solid bg-teal-gradient">
                            ...
                            <div className="box-body border-radius-none">
                                <div className="chart" id="line-chart" alt="height: 250px;"></div>
                            </div>
                            
                            <div className="box-footer no-border">
                                <div className="row">
                                    <div className="col-xs-4 text-center" alt="border-right: 1px solid #f4f4f4">
                                        <input type="text" className="knob" data-readonly="true" value="20" data-width="60" data-height="60" data-fgColor="#39CCCC"></input>

                                            <div className="knob-label">Mail-Orders</div>
                                    </div>
                                    
                                    <div className="col-xs-4 text-center" alt="border-right: 1px solid #f4f4f4">
                                        <input type="text" className="knob" data-readonly="true" value="50" data-width="60" data-height="60" data-fgColor="#39CCCC"></input>

                                            <div className="knob-label">Online</div>
                                    </div>
                                    
                                    <div className="col-xs-4 text-center">
                                        <input type="text" className="knob" data-readonly="true" value="30" data-width="60" data-height="60" data-fgColor="#39CCCC"></input>
                        ...
                        <div className="box box-solid bg-green-gradient">
                            ...
                            <div className="box-body no-padding">
                                ...
                                <div id="calendar" alt="width: 100%"></div>
                            </div>
                                ...
                                <div className="row">
                                    <div className="col-sm-6">
                                        ...
                                        <div className="progress xs">
                                            <div className="progress-bar progress-bar-green" alt="width: 90%;"></div>
                                        </div>
                                        ...
                                        <div className="progress xs">
                                            <div className="progress-bar progress-bar-green" alt="width: 70%;"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <div className="progress xs">
                                            <div className="progress-bar progress-bar-green" alt="width: 60%;"></div>
                                        </div>
                                        ...
                                        <div className="progress xs">
                                            <div className="progress-bar progress-bar-green" alt="width: 40%;"></div>
                                        </div>
                                    </div>
                        ...
                        <li>
                            <a href="javascript:void(0)">
                                ...
                                <div className="progress progress-xxs">
                                    <div className="progress-bar progress-bar-danger" alt="width: 70%"></div>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)">
                                ...
                                <div className="progress progress-xxs">
                                    <div className="progress-bar progress-bar-success" alt="width: 95%"></div>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)">
                                ...
                                <div className="progress progress-xxs">
                                    <div className="progress-bar progress-bar-warning" alt="width: 50%"></div>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)">
                                ...
                                <div className="progress progress-xxs">
                                    <div className="progress-bar progress-bar-primary" alt="width: 68%"></div>
                                </div>
                            </a>
                        </li>
                    </ul>
